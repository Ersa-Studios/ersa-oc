    ...
    <>
      ...
      <main className="relative isolate">
        ...
        >
          ...
          >
            <span style={{ color: "#fff" }}>Repair it.</span>
            <br />
            <span style={{ color: "rgba(255,255,255,0.42)" }}>Build it.</span>
            <br />
            <span style={{ color: "rgba(255,255,255,0.2)" }}>Open it.</span>
          </h1>
          ...
          <div className="mt-10">
            <Link
              href="/join"
              className="inline-flex items-center gap-2.5 px-7 py-3.5 rounded-full text-sm font-semibold bg-white text-black transition-all duration-200 hover:bg-zinc-100 hover:scale-[1.02] active:scale-[0.98]"
            ...
            <div className="px-8 md:px-12 py-10 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              ...
              <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                <a
                  ...
                  className="inline-flex items-center gap-2.5 px-5 py-3 rounded-full text-sm font-medium transition-all duration-200 hover:scale-[1.02]"
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-x-10 gap-y-4">
            ...
            <Link href="/join" className="text-sm hover:text-white/60 transition-colors" style={{ color: "rgba(176,157,255,0.45)" }}>
              see all →
            </Link>
          </div>
        </section>
